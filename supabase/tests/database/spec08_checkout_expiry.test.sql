-- Spec08 disposable variant: jobs are intentionally inactive; frozen Spec07 revokes cron object ACLs.
-- Behavioral expiry assertions below are unchanged from checkout_integrity_expiry.test.sql.
begin;
  ...
  $$
    values (
      pg_catalog.jsonb_build_object(
        ...
        'anon_job_select', false,
        'authenticated_job_select', false,
        'service_job_select', false,
        'anon_schedule_execute', false,
        'authenticated_schedule_execute', false,
        'service_schedule_execute', false
      )
    )
  $$,

...
describe('moderation query cache contracts', () => {
  ...
  it('invalidates only the acting staff member case, queue, and event public projection', async () => {
    ...
    client.setQueryData(moderationKeys.review('organizer-1', 'b4ee321a-bdf6-43b2-a7f4-d6478d942908'), 'owner review')
    client.setQueryData(moderationKeys.review('organizer-2', 'b4ee321a-bdf6-43b2-a7f4-d6478d942908'), 'other owner review')

...
vi.mock('../event-images/eventImages.queries', () => ({ useEventImages: () => ({ data: [], isPending: false, isError: false }), useEventCoverState: () => ({ data: { images: [], revision: 0 }, isPending: false, isError: false }) }))
vi.mock('../event-images/eventFlyer.api', () => ({ replaceEventFlyer: upload, removeEventFlyer: vi.fn() }))

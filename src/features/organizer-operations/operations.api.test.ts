...
const payload = {
  event: { id: eventId, title: 'Night Market', startsAt: null, endsAt: null, venueName: null, city: null, status: 'draft', artworkPath: null },
  grossSalesMinor: 7000, sold: 3, orderCount: 1, issued: 3, checkedIn: 1,
  capacity: 10, tiers: [], admissionEligible: false,
}
describe('organizer metrics transport', () => {
  ...
  it.each([
    { ...payload, sold: -1 }, { ...payload, grossSalesMinor: Number.MAX_SAFE_INTEGER + 1 },
    { ...payload, checkedIn: 4 }, { ...payload, event: { ...payload.event, id: 'a6200000-0000-4000-8000-000000000002' } },
    { ...payload, credential_hash: 'private' }, null,

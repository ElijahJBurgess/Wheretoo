-- Disposable test environment only. Run exclusively via the identity-checked Spec 07 runner.
...
-- Inherited migrations register housekeeping jobs; none may activate in this proof.
